class Err {
     ...
     * 
     * Used to parse error fields, for instance: `FIELD_MAXLENGTH:username:50` decodes to
     * a FIELD_MAXLENGTH error on the username field, with a max allowed length of 50.
     * 
